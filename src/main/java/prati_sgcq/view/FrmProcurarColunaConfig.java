...
public class FrmProcurarColunaConfig extends javax.swing.JDialog {
    ...
    private void btnSalvarConfigColunaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarConfigColunaActionPerformed
        if (tblConfigColuna.getSelectedRow() != -1) {
            config_coluna.setColunaConfig(tblConfigColuna.getValueAt(tblConfigColuna.getSelectedRow(), 1).toString());
            dispose();
        }
    ...
    public final void readColunaConfig() {
        ...
        model.setNumRows(0);
        for (ColunaConfig config : setorDao.readColunaConfig(config_coluna.getTipoColunaConfig())) {
            model.addRow(new Object[]{
                config.getId(),
                config.getColunaConfig(),
                config.getDescricaoColunaConfig()
            });
        }
    }
