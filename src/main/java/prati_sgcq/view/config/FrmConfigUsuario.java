 ...
 * @author rafael
 */
public class FrmConfigUsuario extends javax.swing.JFrame {
    ...
    public FrmConfigUsuario() {
        ...
        URL url = this.getClass().getResource("/Imagem/icon_usuarios.png");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmConfigUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmConfigUsuario().setVisible(true);
            }
        });
    }
...
//        if (Acesso.verificarDeletarDadosUsuario()) {
            ...
            try {
                ...
                if (FrmSalvar.senha()) {
                    setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    userDAO.remover(Usuario.class, (Integer) tblUsuarios.getValueAt(tblUsuarios.getSelectedRow(), 0));
                    setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
                }
            } catch (Exception e) {
